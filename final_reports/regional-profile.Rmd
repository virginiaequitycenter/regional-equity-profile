...
chr_region <- read_csv("../datacode/supplemental_downloadsremoved/data/chr_regional_measures.csv")
...
chr_locality <- read_csv("../datacode/supplemental_downloadsremoved//data/chr_locality_measures.csv")
...
### Child Care
```{r child-care}
child_care_loc <- read_csv("../datacode/supplemental_downloadsremoved//data/child_care_supply_locality.csv")
child_care_region <- read_csv("../datacode/supplemental_downloadsremoved//data/child_care_supply_region.csv") %>% 
...
## Inflow/outflow ----
region_commute <- read_csv("../datacode/supplemental_downloadsremoved//data/inflow_outflow_region.csv") %>%
...
# threeregion_commute <- read_csv("../datacode/supplemental_downloadsremoved//data/inflow_outflow_threeregion.csv")
# 
...
```{r rent-burden, fig.width=9.5, fig.height=3.5, fig.retina = 2, fig.cap="Rent Burdened Households, 2023. In Charlottesville and Albemarle County, 49% of renters are not burdened, 24% are rent burdened and 27% are severely burdened."}
...
mvcounts_dat <- read_csv("../datacode/supplemental_downloadsremoved//data/mvcounts_2011_2023.csv") %>% 
  clean_names()
...
hiccount_2007_2024 <- read_csv("../datacode/supplemental_downloadsremoved//data/hiccount_2007_2024.csv")
