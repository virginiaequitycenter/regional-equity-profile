...
```{r alice-threshold, fig.width = 9.5, fig.height = 6, fig.retina = 2, fig.cap="ALICE Thresholds 2010-2023. The ALICE threshold for households under 65 years old was $69,000 in 2023 and $66,000 for 65 years and older."}
# ALICE thresholds: Charlottesville ----
cville_ALICE_threshold <- read_csv("../data/cville_ALICE_threshold_2010_2023.csv")
...
# ALICE households by race/ethnicity: Charlottesville ----
cville_ALICE_households_by_race <- read_csv("../data/cville_ALICE_households_by_race_2023.csv")
...
zillow_rent <- read_csv("../data/zillow_rent_2015_2024.csv") %>% 
  filter(RegionName %in% c("Charlottesville City", "United States", "Virginia")) %>% 
...
zillow_rent %>% 
  mutate(text = case_when(RegionName == "Charlottesville City" ~ paste0("$", prettyNum(round(rent, -1), big.mark=",", preserve.width="none"))),
                          .default = "") %>% 
  ...
  scale_y_continuous(limits = c(750,2000),
                     ...
                     labels = scales::label_currency(scale = 1),
                     name = "") +
  scale_color_manual(values = c("United States" = "#b2b8be", "Virginia" = "#3B8EA5", "Charlottesville City" = "#005191")) +
  labs(color = "",
