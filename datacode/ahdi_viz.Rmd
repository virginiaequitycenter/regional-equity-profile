...
```{r, echo=FALSE, fig.width=9}
# AHDI Benchmarks ----
alb_bench <- c("51","51003","51540", "51015","51029","51041","51059","51061","51075","51085","51087","51095","51107","51121","51153","51161","51165","51177","51550","51650","51660","51680","51770","51760","51810")
...
ahdi_table_alb <- ahdi_benchmarks %>% 
  ...
  mutate(name_order = fct_relevel(name, c("Albemarle", "Charlottesville", "Virginia", 
                                          "Augusta County","Buckingham County","Chesapeake City", "Chesterfield County","Fairfax County","Fauquier County","Goochland County","Hanover County","Hampton City","Harrisonburg City","Henrico County","James City County","Loudoun County","Lynchburg City","Montgomery County","Prince William County","Richmond City", "Roanoke City", "Roanoke County","Rockingham County","Spotsylvania County", "Virginia Beach City"))) %>%
  arrange(name_order) %>%
  mutate(`American HD Index` = round(ahdi, 1),
         across(lifeexp_est:enrollment_per, ~ round(.x, 0))) %>% 
  select(name, `American HD Index`, lifeexp_est:med_earnings) %>% 
