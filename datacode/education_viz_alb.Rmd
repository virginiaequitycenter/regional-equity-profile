...
alb_adv_enroll %>% 
  ...
  labs(color = "", title = "ACPS AP & Dual Enrollment 2022-2023") +
  theme_minimal() +
  theme(legend.title=element_blank(),
        legend.position = "top",
        panel.grid.major.x = element_blank(),
...
alb_suspensions %>% 
  ...
  labs(fill = "", title = "ACPS Short Term Suspension Incidents, by Race/Ethnicity")
...
alb_absent %>% 
  ...
  scale_y_continuous(labels = label_percent(scale = 1),
                     limits = c(0,60),
                     name = "") +
  labs(color = "", title = "ACPS Chronic Absenteeism 2022-2023") +
  theme_minimal() +
  theme(legend.title=element_blank(),
        panel.grid.major.x = element_blank(),
        axis.ticks = element_blank(),
